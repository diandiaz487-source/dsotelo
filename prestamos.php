...
<nav class="topnav">
  ...
  <a href="prestamos.php" class="active">
...
<main>
  ...
  <?php if ($msg): ?>
    ...
    <div class="<?= $tipo === 'success' ? 'alert-ok' : 'alert-err' ?>">
      <?= $texto ?>
    </div>
  ...
  <div class="bib-card">
    ...
    <h5 style="color:#be185d;font-family:'Playfair Display',serif;margin:0 0 1rem;">
      Pedir un libro
    </h5>

    <?php if (empty($disponibles)): ?>

      <p style="color:#f472b6;font-size:14px;">
    ...
    <form method="POST">
      ...
      <button class="bib-btn" type="submit">
        Pedir préstamo
      </button>
  ...
  <div class="bib-card">
    ...
    <?php if (empty($misprestamos)): ?>
      ...
      <p style="color:#f472b6;font-size:14px;">
        No has pedido ningún libro todavía.
      </p>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <span class="<?= $p['estado'] === 'activo' ? 'badge-activo' : 'badge-devuelto' ?>">
                <?= ucfirst($p['estado']) ?>
              </span>
            </td>
            ...
            <td>
              ...
              <?php else: ?>
                ...
                <span style="color:#f472b6;font-size:12px;">
                  <?= $p['fecha_devolucion'] ?>
                </span>
